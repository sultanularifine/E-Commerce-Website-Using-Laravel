                ...
                <div class="modal-body">
                    <div class="card-body">
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-12 col-sm-12">
                                <input type="file" name="image" class="custom-file-input" placeholder="" accept="image/*">
