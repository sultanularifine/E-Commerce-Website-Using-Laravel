            ...
            <div class="container-fluid">
                <div class="card card-primary">
                    <div class="card-header">
                        <h5 class="card-title">Edit Home Services</h5>
                    </div>
                    <!-- form start -->
                    <form action="{{ route('home_services.update', $home_services->id) }}" method="POST"
                        ...
                        <div class="card-body">
                            <div class="form-row">
                                <div class="form-group col-md-6 col-sm-12">
                                    ...
                                    placeholder="Enter Title" value="{{ $home_services->title }}">
                                </div>
                                <div class="form-group col-md-6 col-sm-12">
                                    <label for="link">Icon Class</label>
                                    <input type="text" class="form-control" name="icon_class" id="link"
                                        placeholder="Enter Icon Class" value="{{ $home_services->icon_class }}">
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-12 col-sm-12">
                                    <label for="details">Description</label>
                                    <textarea name="description" class="form-control summernote" data-height="100">{{ $home_services->description }}</textarea>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-6 col-sm-12">
                                ...
                                <div>
                                    <img src="{{ asset('storage/home_services/' . $home_services->bg_image) }}" width="70px" height="70px" alt="">
                                </div>
                            </div>
